...
class QuestionController extends Controller
{
    ...
    public function store(QuestionCreateRequest $request ,$id)
    {
        ...
        return redirect()->route('questions.index',$id)->withSuccess('soru başarılıyla oluşturuldu');
    }
    ...
    public function update(QuestionUpdateRequest $request, $quiz_id,$question_id)
    {
        ...
        return redirect()->route('questions.index',$quiz_id)->withSuccess('soru başarılıyla oluşturuldu');
    ...
    public function destroy($quiz_id,$question_id)
    {
        ...
        return redirect()->route('questions.index',$quiz_id)->withSuccess('soru başarılıyla silindi');
